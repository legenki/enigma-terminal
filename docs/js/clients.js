...
export const CLIENTS = [
  {
    ...
    "creed": {
      ...
      "es": [
        "MERIDIAN no posee nada y no quiere poseer nada. Solo encuentra.",
      ...
      "pt": [
        "A MERIDIAN não possui nada e não quer possuir nada. Ela encontra.",
    ...
    "dialect": {
      ...
      "es": "MERIDIAN piensa en entropía. Sus analistas no recuperan palabras, sino los bytes de los que nacieron esas palabras.",
      "pt": "A MERIDIAN pensa em entropia. Seus analistas não recuperam palavras, mas os bytes dos quais as palavras brotaram."
    },
    "archetypes": [
      "entropy_pattern",
      "index_math",
    ...
    "evidence_sources": {
      ...
      "es": [
        "un extracto de terminal MERIDIAN",
      ...
      "pt": [
        "um extrato de terminal da MERIDIAN",
  ...
  },
  {
    ...
    "creed": {
      ...
      "es": [
        "SEVENTH SIGN vende cuadros que nadie ha visto a gente que nadie conoce.",
    ...
    "dialect": {
      ...
      "es": "EL SÉPTIMO SIGNO esconde palabras en los importes. Olvida el resto: lee los últimos dígitos del precio.",
      "pt": "O SÉTIMO SINAL esconde palavras dentro de quantias. Esqueça o lote — leia os últimos dígitos do preço."
    },
    "archetypes": [
      "ledger_amounts",
      "mirror_index",
  ...
  },
  {
    ...
    "creed": {
      ...
      "es": [
        "DEEPHOLD compró siete plataformas fuera de servicio y hundió un centro de datos en cada una.",
      ...
      "pt": [
        "A DEEPHOLD comprou sete plataformas descomissionadas e afundou um centro de dados em cada uma.",
    ...
    "dialect": {
      ...
      "es": "DEEPHOLD despliega la lista de palabras en una cuadrícula: 128 filas por 16 columnas. Una palabra es un punto en el mapa.",
      "pt": "DEEPHOLD dispõe a lista de palavras em uma grade: 128 linhas por 16 colunas. Uma palavra é um ponto em um gráfico."
    },
    "archetypes": [
      "grid_coords",
      "neighbour",
  ...
  },
  {
    ...
    "creed": {
      ...
      "es": [
        "VEGA guarda las llaves donde ningún tribunal puede llegar: a cuatrocientos kilómetros de altura.",
      ...
      "pt": [
        "A VEGA guarda chaves onde nenhum tribunal alcança: a quatrocentos quilômetros de altitude.",
    ...
    "dialect": {
      ...
      "es": "VEGA dicta números en lugar de palabras, y nunca de forma directa. El índice debe ser calculado.",
      "pt": "VEGA dita números em vez de palavras, e nunca de forma clara. O índice precisa ser calculado."
    },
    "archetypes": [
      "index_math",
      "mirror_index",
  ...
  },
  {
    ...
    "creed": {
      ...
      "es": [
        "WHITEBONE te habla con la voz de una enfermera que ya ha tomado una decisión.",
      ...
      "pt": [
        "WHITEBONE fala com você com a voz de uma enfermeira que já tomou sua decisão.",
    ...
    "dialect": {
      ...
      "es": "WHITEBONE describe una palabra por su singularidad: solo una rama en la lista encaja.",
      "pt": "WHITEBONE descreve uma palavra por sua singularidade: apenas um ramo na lista se encaixa."
    },
    "archetypes": [
      "unique_prefix",
      "neighbour",
  ...
  },
  {
    ...
    "creed": {
      ...
      "es": [
        ...
        "GOST-9 sigue sellando, numerando lo que llega y tachando lo que no debe saberse.",
      ...
      "pt": [
        ...
        "GOST-9 continua carimbando, numerando o que chega e apagando o que não deve ser conhecido.",
    ...
    "dialect": {
      ...
      "es": "GOST-9 lo suelta todo menos una palabra: esa está censurada. Recupérala mediante la suma de comprobación — COMPLETADO.",
      "pt": "O GOST-9 libera tudo, menos uma palavra: essa foi censurada. Recupere-a via checksum — CONCLUÍDO."
    },
    "archetypes": [
      "redacted",
      "unique_prefix",
  ...
  },
  {
    ...
    "creed": {
      ...
      "es": [
        "MICA es dueña de la red. No la social, sino la eléctrica; sin ella, nada funciona.",
        ...
        "Cada uno de sus documentos es simétrico: la mica se divide en láminas espejadas uniformes,",
        "y ellos hacen lo mismo con las palabras. Lee desde el extremo opuesto."
      ],
      "pt": [
        "A MICA é dona da rede. Não a social — a elétrica, sem a qual nada funciona.",
        ...
        "Cada documento deles é simétrico: a mica se divide em lâminas espelhadas e uniformes,",
    ...
    "dialect": {
      ...
      "es": "MICA refleja la lista de palabras: la palabra en la posición N corresponde a la palabra en la posición 2049 − N.",
      "pt": "MICA espelha a lista de palavras: a palavra em N corresponde à palavra em 2049 − N."
    },
    "archetypes": [
      "mirror_index",
      "grid_coords",
  ...
  },
  {
    ...
    "creed": {
      ...
      "es": [
        "LAST ARCHIVE sostiene que una billetera olvidada es una persona olvidada, y se niega a aceptarlo.",
      ...
      "pt": [
        "O LAST ARCHIVE sustenta que uma carteira esquecida é uma pessoa esquecida, e recusa-se a aceitar isso.",
    ...
    "dialect": {
      ...
      "es": "EL ÚLTIMO ARCHIVO guía palabra por palabra: cada una se sitúa junto a una palabra conocida en la lista BIP-39.",
      "pt": "ÚLTIMO ARQUIVO leva palavra por palavra: cada uma se posiciona ao lado de uma palavra conhecida na lista BIP-39."
    },
    "archetypes": [
      "neighbour",
      "redacted",
