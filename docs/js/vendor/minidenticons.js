// minidenticons — vendored from https://github.com/laurentpayot/minidenticons
//
// MIT License. Copyright (c) 2021 Laurent Payot.
// Full licence text sits beside this file in LICENSE.
//
// Vendored rather than loaded from a CDN so the published page stays entirely
// self-contained — the game must work with no third-party requests. Lines 1-34
// of the upstream module are reproduced verbatim; only the custom-element
// wrapper that follows them is dropped, since this build calls the function
// directly.
