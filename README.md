...
|---|---|---|
| МЕРИДИАН | частное бюро криминалистики | энтропия, прямые номера, уникальные ветки |
| СЕДЬМОЙ ЗНАК | серый фонд, аукционный дом | номер слова зашит в цену лота |
| ГЛУБИНА | подводные дата-убежища | словарь как сетка 128 × 16 |
| ВЕГА-ОРБИТАЛ | орбитальное хранение ключей | индекс надо вычислить |
| БЕЛАЯ КОСТЬ | биотех и клиники аренды тела | единственная ветка словаря |
| ГОСТ-9 | ведомство несуществующего государства | одно слово вымарано, вернуть через `COMPLETE` |
| СЛЮДА | минеральный конгломерат | зеркало: номер = 2049 − названный |
| ПОСЛЕДНИЙ АРХИВ | архивисты, платят информацией | цепочка соседей по словарю |
