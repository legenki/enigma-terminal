...
|---|---|---|
| МЕРИДИАН · Микросентро | частное бюро криминалистики | энтропия, прямые номера, уникальные ветки |
...
| ГОСТ-9 · Бальванера | ведомство несуществующего государства | одно слово вымарано, вернуть через `COMPLETE` |
| СЛЮДА · Каталинас-Норте | минеральный конгломерат | зеркало: номер = 2049 − названный |
